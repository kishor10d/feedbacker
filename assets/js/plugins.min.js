...
$(document).ready(function(){jQuery.validator.addMethod("selected",function(e,t){return 0!=e},"This field is required."),jQuery.validator.addMethod("acceptImgExtension",function(e,t){if(""==e)return!0;var a=e.substring(e.lastIndexOf(".")+1).toLowerCase();return"jpg"==a||"png"==a||"jpeg"==a||"gif"==a},""),jQuery.validator.addMethod("acceptDocExtension",function(e,t){if(""==e)return!0;var a=e.substring(e.lastIndexOf(".")+1).toLowerCase();return"jpg"==a||"png"==a||"jpeg"==a||"gif"==a},""),jQuery.validator.addMethod("checkEmailExist",function(e,t){var a=!1,r=baseurl+"user/checkEmailExist/";return $.ajax({type:"POST",url:r,data:{email:e},dataType:"json",async:!1}).done(function(e){a=1!=e.status}),a},"Email already taken."),jQuery.validator.addMethod("checkDateFormat",function(e,t){var a=/^(?:(?:31(\/|-|\.)(?:0?[13578]|1[02]))\1|(?:(?:29|30)(\/|-|\.)(?:0?[1,3-9]|1[0-2])\2))(?:(?:1[6-9]|[2-9]\d)?\d{2})$|^(?:29(\/|-|\.)0?2\3(?:(?:(?:1[6-9]|[2-9]\d)?(?:0[48]|[2468][048]|[13579][26])|(?:(?:16|[2468][048]|[3579][26])00))))$|^(?:0?[1-9]|1\d|2[0-8])(\/|-|\.)(?:(?:0?[1-9])|(?:1[0-2]))\4(?:(?:1[6-9]|[2-9]\d)?\d{2})$/gm;return!!a.test(e)},"Please enter correct date."),jQuery.validator.addMethod("checkWhiteSpaces",function(e,t){var a=/\s/;return!a.test(e)},"Spaces are not allowed in username.")});
